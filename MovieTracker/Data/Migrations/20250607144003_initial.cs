    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Series_Platforms_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platforms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Series_Ratings_RatingId",
                        column: x => x.RatingId,
                        principalTable: "Ratings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorsSeries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActorsSeries_Actors_ActorId",
                        column: x => x.ActorId,
                        principalTable: "Actors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActorsSeries_Series_SerieId",
                        column: x => x.SerieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorsSeries_ActorId",
                table: "ActorsSeries",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_ActorsSeries_SerieId",
                table: "ActorsSeries",
                column: "SerieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Series_PlatformId",
                table: "Series",
                column: "PlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_Series_RatingId",
                table: "Series",
                column: "RatingId",
                unique: true,
